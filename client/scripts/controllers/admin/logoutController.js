angular.module('app').controller('logoutController', ['$scope', '$rootScope', '$compile', '$window', 'cfpLoadingBar','Service', function ($scope, $rootScope, $compile, $window, cfpLoadingBar, Service) {
    // holds the error
    $scope.error = {
        "error": false,
        "title": "",
    ...
    // logout
    Service.logout().then(function (responseL) {
        // if no error
        if(!responseL.error) {
