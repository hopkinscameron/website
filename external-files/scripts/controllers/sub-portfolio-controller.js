...
// load the data for the Sub Portfolio page
loadSubPortfolioPageData();

// loads the data for the Sub Portfolio page
function loadSubPortfolioPageData() {
    var app = angular.module('subPortfolioApp', []).filter('trustUrl', function ($sce) {
        return function (url) {
