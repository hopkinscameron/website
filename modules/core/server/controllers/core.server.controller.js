...
exports.renderIndex = function (req, res) {
    ...
    var indexFilePath = 'modules/core/server/views/index'; //process.env.NODE_ENV === 'production' || process.env.NODE_ENV === 'uproduction' ? 'modules/core/server/index/index' : 'modules/core/server/views/index';
