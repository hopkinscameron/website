...
// set up the module
var dashboardServiceModule = angular.module('dashboard.services');

// create the factory
dashboardServiceModule.factory('DashboardFactory', ['$http', '$location', '$rootScope', function ($http, $location, $rootScope) {
    // set up the factory
    var factory = {};
