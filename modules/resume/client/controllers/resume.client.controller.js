...
resumeModule.controller('ResumeController', ['$scope', '$rootScope', '$compile', '$location', '$timeout', 'ngDialog', 'Service', 'ResumeFactory', function ($scope, $rootScope, $compile, $location, $timeout, ngDialog, Service, ResumeFactory) {
