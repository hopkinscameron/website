...
(function (root, factory) {
    ...
    var focusableElementSelector = 'a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, *[taonex], *[contenteditable]';
            ...
            function ($document, $templateCache, $compile, $q, $http, $rootScope, $timeout, $window, $controller, $injector) {
                ...
                var privateMethods = {
                    ...
                    performCloseDialog: function ($dialog, value) {
                        ...
                        if (dialogsCount === 1) {
                            $elements.body.off('keydown', privateMethods.onDocumentKeydown);
                        }
                    ...
                    autoFocus: function($dialog) {
                        ...
                        if (contentElements.length > 0) {
                            ...
                            $el(contentElement).attr('taonex', '-1').css('outline', '0');
                    ...
                    getFocusableElements: function ($dialog) {
                        ...
                        // Ignore untabbable elements, ie. those with taonex = -1
                ...
                var publicMethods = {
                    ...
                    open: function (opts) {
                        ...
                        $q.all({
                            ...
                            if (!keydownIsBound) {
                                $elements.body.on('keydown', privateMethods.onDocumentKeydown);
                                keydownIsBound = true;
                            }
            ...
            link: function (scope, elem, attrs) {
                elem.on('click', function (e) {
                    ...
                    ngDialog.open({
                        ...
                        onToController: attrs.ngDialogonToController,
